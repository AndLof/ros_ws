...
public:
    ...
    QLabel *label_21;
    QComboBox *comboBox_env_sensor_graph_colormap;
    ...
    void setupUi(QMainWindow *DatabaseViewer)
    {
        ...
        verticalLayout_15->addLayout(horizontalLayout_imageViews);
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 364, 389));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 364, 389));
        ...
        verticalLayout_6 = new QVBoxLayout(widget_imageControls_B);
        ...
        verticalLayout_15->addWidget(buttonBox);
        ...
        verticalLayout_61 = new QVBoxLayout(widget_graphControl);
        ...
        verticalLayout_91 = new QVBoxLayout();
        ...
        gridLayout_5->addWidget(label_45, 8, 1, 1, 1);
        ...
        gridLayout_5->addWidget(label_timeOptimization, 7, 0, 1, 1);
        ...
        gridLayout_5->addWidget(label_rmse, 9, 0, 1, 1);
        ...
        gridLayout_5->addWidget(label_rmse_title, 9, 1, 1, 1);
        ...
        gridLayout_5->addWidget(label_loopClosures, 11, 0, 1, 1);
        ...
        gridLayout_5->addWidget(label_poses, 10, 0, 1, 1);
        ...
        gridLayout_5->addWidget(label_pathLength, 6, 0, 1, 1);

        label_52 = new QLabel(widget_graphControl);
        label_52->setObjectName(QString::fromUtf8("label_52"));

        gridLayout_5->addWidget(label_52, 10, 1, 1, 1);

        label_10 = new QLabel(widget_graphControl);
        label_10->setObjectName(QString::fromUtf8("label_10"));

        gridLayout_5->addWidget(label_10, 6, 1, 1, 1);
        ...
        gridLayout_5->addWidget(label_41, 11, 1, 1, 1);
        ...
        gridLayout_5->addWidget(label_timeGrid, 8, 0, 1, 1);
        ...
        label_21 = new QLabel(widget_graphControl);
        label_21->setObjectName(QString::fromUtf8("label_21"));

        gridLayout_5->addWidget(label_21, 5, 1, 1, 1);

        comboBox_env_sensor_graph_colormap = new QComboBox(widget_graphControl);
        comboBox_env_sensor_graph_colormap->addItem(QString());
        comboBox_env_sensor_graph_colormap->addItem(QString());
        comboBox_env_sensor_graph_colormap->addItem(QString());
        comboBox_env_sensor_graph_colormap->addItem(QString());
        comboBox_env_sensor_graph_colormap->addItem(QString());
        comboBox_env_sensor_graph_colormap->addItem(QString());
        comboBox_env_sensor_graph_colormap->setObjectName(QString::fromUtf8("comboBox_env_sensor_graph_colormap"));

        gridLayout_5->addWidget(comboBox_env_sensor_graph_colormap, 5, 0, 1, 1);
        ...
        verticalLayout_61->addLayout(verticalLayout_91);
        ...
        page_4->setGeometry(QRect(0, 0, 276, 1598));
        ...
        page_5->setGeometry(QRect(0, -152, 403, 287));
        ...
        gridLayout_10->addItem(verticalSpacer_5, 8, 0, 1, 1);
        ...
        spinBox_fromToMapId = new QSpinBox(page_5);
        spinBox_fromToMapId->setObjectName(QString::fromUtf8("spinBox_fromToMapId"));
        spinBox_fromToMapId->setMinimum(-1);
        spinBox_fromToMapId->setMaximum(9999);
        spinBox_fromToMapId->setValue(-1);

        gridLayout_10->addWidget(spinBox_fromToMapId, 7, 0, 1, 1);

        label_38 = new QLabel(page_5);
        label_38->setObjectName(QString::fromUtf8("label_38"));

        gridLayout_10->addWidget(label_38, 7, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *DatabaseViewer)
    {
        ...
        label_21->setText(QCoreApplication::translate("DatabaseViewer", "Env Sensor Colormap", nullptr));
        comboBox_env_sensor_graph_colormap->setItemText(0, QCoreApplication::translate("DatabaseViewer", "Disabled", nullptr));
        comboBox_env_sensor_graph_colormap->setItemText(1, QCoreApplication::translate("DatabaseViewer", "Wifi", nullptr));
        comboBox_env_sensor_graph_colormap->setItemText(2, QCoreApplication::translate("DatabaseViewer", "Temperature", nullptr));
        comboBox_env_sensor_graph_colormap->setItemText(3, QCoreApplication::translate("DatabaseViewer", "Air Pressure", nullptr));
        comboBox_env_sensor_graph_colormap->setItemText(4, QCoreApplication::translate("DatabaseViewer", "Light", nullptr));
        comboBox_env_sensor_graph_colormap->setItemText(5, QCoreApplication::translate("DatabaseViewer", "Relative Humidity", nullptr));
        ...
        label_38->setText(QCoreApplication::translate("DatabaseViewer", "From/to map ID only (-1 is all)", nullptr));
