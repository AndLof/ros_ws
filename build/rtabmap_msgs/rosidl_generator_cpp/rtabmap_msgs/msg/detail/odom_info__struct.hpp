...
struct OdomInfo_
{
    ...
    local_scan_map(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->local_bundle_avg_inlier_distance = 0.0f;
      this->local_bundle_max_key_frames_for_inlier = 0l;
  ...
  using _local_bundle_avg_inlier_distance_type =
    float;
  _local_bundle_avg_inlier_distance_type local_bundle_avg_inlier_distance;
  using _local_bundle_max_key_frames_for_inlier_type =
    int32_t;
  _local_bundle_max_key_frames_for_inlier_type local_bundle_max_key_frames_for_inlier;
  ...
  Type & set__local_bundle_avg_inlier_distance(
    const float & _arg)
  {
    this->local_bundle_avg_inlier_distance = _arg;
    return *this;
  }
  Type & set__local_bundle_max_key_frames_for_inlier(
    const int32_t & _arg)
  {
    this->local_bundle_max_key_frames_for_inlier = _arg;
    return *this;
  }
  ...
  bool operator==(const OdomInfo_ & other) const
  {
    ...
    if (this->local_bundle_avg_inlier_distance != other.local_bundle_avg_inlier_distance) {
      return false;
    }
    if (this->local_bundle_max_key_frames_for_inlier != other.local_bundle_max_key_frames_for_inlier) {
      return false;
    }
